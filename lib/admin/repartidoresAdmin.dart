...
class RepartidoresAdmin extends StatefulWidget {
  const RepartidoresAdmin({Key? key});
  @override
  State<RepartidoresAdmin> createState() => _RepartidoresAdminState();
}

class _RepartidoresAdminState extends State<RepartidoresAdmin>{
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
          stream: _firestore.collection('users').where('rol', isEqualTo: 'repartidor').snapshots(),
